...
2.  **Binding Validation (under empirical test):** The 2026-02-21 3-condition synthetic test demonstrated phi monotonicity with binding strength on a controlled stimulus. The 2026-05-14 ablation campaign tested whether phi-sync_R correlation emerges during training across 5 architectural variants of the pyphi pipeline ([docs/results/ablation_2026_05_14.md](docs/results/ablation_2026_05_14.md)): correlation r ranged from +0.023 to +0.089, all failing the pre-registered r > 0.4 prediction. A 2026-05-16 follow-up tested a fundamentally different phi formulation (RIIU, sliding-window SVD on continuous activations, [docs/results/riiu_compare_2026_05_16.md](docs/results/riiu_compare_2026_05_16.md)); RIIU also failed Phi-1 at r=+0.0754 over the full 200-episode run, though a transient peak of r=+0.267 appeared mid-training before collapsing. The relationship between binding and integration during learning remains an open question.
